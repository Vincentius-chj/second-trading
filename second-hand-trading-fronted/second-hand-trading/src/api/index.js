...
const api = {
    ...
    // 快捷地址管理
    getDefaultAddressOptions(query) {
        return request({
            url: '/address/default-options',
            method: 'get',
            params: query
        });
    },
    // 管理员快捷地址管理
    adminListDefaultAddress(query) {
        return request({
            url: '/admin/address/default/list',
            method: 'get',
            params: query
        });
    },
    adminAddDefaultAddress(data) {
        return request({
            url: '/admin/address/default/add',
            method: 'post',
            data: data
        });
    },
    adminDeleteDefaultAddress(data) {
        return request({
            url: '/admin/address/default/delete',
            method: 'post',
            data: data
        });
    },
